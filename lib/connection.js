...
const { getPausedChats } = require("../assets/database/PausedChat");  // Correct import for getPausedChats
...
const processMessage = async (msg, conn, m) => {
  ...
  const pausedChats = await getPausedChats();  // Correctly call getPausedChats
